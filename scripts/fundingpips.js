 ...
 *{box-sizing:border-box}
 ...
 /* Profit split bar — tighter spacing between bar and % */
 .splitbar {
 display: flex; /* switch from grid → flex for better control */
 align-items: center;
 justify-content: center;
 gap: 4px; /* reduce the spacing between bar and % */
 min-width: 140px;
 }
 
 .splitbar .track {
 position: relative;
 width: 70px; /* a bit narrower, you can tweak this */
 height: 10px;
 background: #0f172a;
 ...
 font-weight: 900;
 color: #e9f7ff;
 text-align: left; /* aligns neatly beside the bar */
 font-size: 0.9rem;
 margin-left: 2px; /* fine-tune distance */
 transform: translateY(-0.5px); /* visually centered */
 }
 ...
 /* Price + Buy layout (stacked prices, inline button) */
 .price-wrap {
 display: inline-flex;
 align-items: center;
 ...
 .price-stack {
 display: flex;
 flex-direction: column; /* new price above old */
 ...
 border-radius: 10px;
 padding: 6px 10px;
 box-shadow: 0 0 10px rgba(51,204,255,0.15);
 }
 /* Fix right edge of the price cell */
 ...
 .challenges-table td:last-child .price-wrap {
 background: transparent !important;
 ...
 font-weight: 700;
 font-size: 0.85rem;
 opacity: 0.75; /* subtle fade to make new price pop */
 }
 ...
 /* Subtle visual divider before Price column */
 .challenges-table td:nth-last-child(2) {
 ...
 <div class="price-old">$555.00</div>
 </div>
 <a href="${r.url}" target="_blank" rel="noopener" class="buy-btn">Buy</a>
 </div>
 </td>
